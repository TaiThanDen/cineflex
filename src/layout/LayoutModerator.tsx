...
import VerticalSidebar_moderator from "../components/moderator/LayoutModerator/VerticalSidebar_moderator.tsx";
...
const LayoutModerator = ({ children }: Props) => {
    ...
    return (
        <div className="flex min-h-screen bg-[#f6f8fa] relative">
            {/* Sidebar cho desktop */}
            {!isMobile && <VerticalSidebar_moderator />}
...
export default LayoutModerator;
