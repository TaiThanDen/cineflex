    ...
    <li className="my-5 relative">
      <span className="relative h-full text-white">
        ...
        >
          ...
          <FaChevronDown
            className={`w-4 h-4 lg:flex-none flex-[0.2] transition-transform ${
              isOpen ? "rotate-180" : ""
            }`}
          />
        </button>
      ...
      <ul
        className={`absolute left-0 mt-2 w-48 bg-gray-800 rounded-md shadow-lg overflow-hidden transition-all duration-300 ${
