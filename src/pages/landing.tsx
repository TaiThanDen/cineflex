...
const faqs = [
  ...
  {
    question:
      "Tôi có thể sử dụng Cineflex trên điện thoại hoặc máy tính bảng không?",
    answer:
            ...
            <Disclosure key={idx}>
              {({ open }) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <Disclosure.Button className="flex justify-between items-center w-full py-4 text-left text-lg font-medium text-white hover:text-purple-400 transition-colors">
...
const Landing: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (Hls.isSupported()) {
      const hls = new Hls();
      hls.loadSource(
        "https://stream.mux.com/fF01gyvBNecwccLiMithDMIhUylC8EIvp2yq5JL301TrM.m3u8?redundant_streams=true"
      );
      ...
      // For checking if can play .m3u8 by default: Apple’s HLS (HTTP Live Streaming) playlist format.
      video.src =
        "https://stream.mux.com/fF01gyvBNecwccLiMithDMIhUylC8EIvp2yq5JL301TrM.m3u8?redundant_streams=true";
    } else {
  ...
  return (
    <div className="bg-[#23263A]">
      ...
      <div className="relative w-full h-screen overflow-hidden text-white">
        ...
        <div className="relative z-10 px-8 lg:px-24 h-full flex items-center">
          <motion.div
            className="max-w-2xl space-y-6 bg-white/8 backdrop-blur-sm rounded-4xl p-10"
            variants={fadeUp}
            initial="hidden"
            animate="visible"
          >
            ...
            <p className="text-md text-gray-200 leading-relaxed">
              ...
              <br /> Cineflex mang đến trải nghiệm xem phim linh hoạt, mọi lúc
              mọi nơi.
              <br /> Dù bạn đang ở nhà hay đang di chuyển tất cả chỉ với một cú
              chạm.
            </p>
            <Link to="/home">
              <motion.span
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-purple-500 mb-6">
              Chúng tôi là Cineflex
            </h2>
            <p className="text-gray-300 text-lg leading-relaxed">
              Được sinh ra với sứ mệnh mang điện ảnh đến gần hơn với mọi
              người...
            </p>
            <p className="text-gray-300 text-lg leading-relaxed mt-4">
              Hãy cùng chúng tôi khám phá thế giới điện ảnh đầy màu sắc và cảm
              xúc...
            </p>
            <div className="mt-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-sm text-gray-300 mb-4">
              Chúng tôi cam kết bảo vệ thông tin cá nhân và dữ liệu xem của bạn
              bằng các tiêu chuẩn bảo mật cao cấp.
            </p>
            <Link
              to="#"
              className="text-purple-500 text-sm inline-flex items-center gap-1 hover:underline"
            >
          ...
          >
            ...
            <p className="text-sm text-gray-300 mb-4">
              Chỉ cần thanh toán để gỡ bỏ quảng cáo. Tận hưởng trải nghiệm xem
              trọn vẹn mà không cần gói phức tạp.
            </p>
            <Link
              to="/plans"
              className="text-purple-500 text-sm inline-flex items-center gap-1 hover:underline"
          ...
          >
            ...
            <p className="text-sm text-gray-300 mb-4">
              Từ phim bom tấn Hollywood đến điện ảnh Châu Á, bạn có thể khám phá
              thế giới phim ảnh mà không bị giới hạn.
            </p>
            <Link
              to="/home"
              className="text-purple-500 text-sm inline-flex items-center gap-1 hover:underline"
